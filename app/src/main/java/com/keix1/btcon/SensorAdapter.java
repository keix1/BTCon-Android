...
public class SensorAdapter implements SensorEventListener{
    ...
    public float getAccX(){return this.currentAccelerationValues[0];}
    public float getAccY(){return this.currentAccelerationValues[1];}
    public float getAccZ(){return this.currentAccelerationValues[2];}
